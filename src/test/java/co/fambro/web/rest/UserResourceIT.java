...
import co.fambro.FambroApp;
import co.fambro.RedisTestContainerExtension;
import co.fambro.domain.Authority;
import co.fambro.domain.User;
import co.fambro.repository.UserRepository;
import co.fambro.repository.search.UserSearchRepository;
import co.fambro.security.AuthoritiesConstants;
import co.fambro.service.dto.UserDTO;
import co.fambro.service.mapper.UserMapper;
import co.fambro.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = FambroApp.class)
...
public class UserResourceIT {
    ...
    /**
     * This repository is mocked in the co.fambro.repository.search test package.
     *
     * @see co.fambro.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
